...
# SPECIFICATION: This program will help you learn how to classify fashion items.
# Using the MNIST Fashion dataset as well as Keras to load the dataset, the goal
# is to train and test multiple deep neural networks and their performances, updating
# the highest accuracy found. Using a separate function named build_model() the
# program will define the architectures of the neural networks. Lastly, the weights
# of the best model will be printed together with the architecture and the learning
# curves.
