...
# SPECIFICATION: This program will read the file retail_dataset.csv to find 
# strong rules related to supermarket products. Goal is to output the rules 
# that satisfy minsup = 0.2 and minconf = 0.6 with priors and probability gains
# when conditioned to the antecedents.
...
encoded_vals = []
for element_index, row in df.iterrows():
